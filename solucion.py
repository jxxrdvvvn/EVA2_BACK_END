...
def decidir(cantidad, estado):
    """
    Función adaptadora para la EVA2. 
    Usa la regla de negocio original evaluar_despacho sin modificarla.
    """
    # Pasamos un stock de referencia suficiente para evaluar según la cantidad y el estado
    stock_referencia = 0 if estado == "moroso" else 100
    est, motivo = evaluar_despacho("Producto", stock_referencia, cantidad)
    return f"{est}: {motivo}"
